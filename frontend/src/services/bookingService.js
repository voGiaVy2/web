...
const cancelMyBooking = (id) => api.put(`/bookings/${id}/cancel`).then((r) => r.data);

export default { createBooking, getMyBookings, getAllBookings, updateBookingStatus, cancelMyBooking };
